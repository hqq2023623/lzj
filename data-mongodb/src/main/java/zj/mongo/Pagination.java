...
public class Pagination {
    ...
    public Pagination(int currentPage, Long totalNumber) {
        ...
        this.sort = new Sort(new Sort.Order(Sort.Direction.ASC, "_id"));
    }
    ...
    public void setSort(String dir, boolean isAsc) {
        if (isAsc) {
            this.sort = new Sort(new Sort.Order(Sort.Direction.ASC, dir));
        } else {
            this.sort = new Sort(new Sort.Order(Sort.Direction.DESC, dir));
        }
